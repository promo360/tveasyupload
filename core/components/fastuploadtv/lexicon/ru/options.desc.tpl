...
<p>Путь к сохраненному файлу и дополнительный префикс имени файла могут быть настроены динамически с несколькими заполнителями:
    <ul>
        ...
        <li><span>{alias}</span>  - Алиас ресурса (ВАЖНО! Алиас не должен содержать спецсиволов, запрещенных в ОС)</li>
        <li><span>{palias}</span> - Алиас ресурса родителя (ВАЖНО! Алиас не должен содержать спецсиволов, запрещенных в ОС)</li>
